    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4 h-14 gap-3">
        ...
        <nav className="hidden md:flex items-center gap-1 flex-1 justify-center">
          <NavLink to="/" active={pathname === '/'}>{t('nav.markets')}</NavLink>
        </nav>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div ref={langRef} className="relative">
            ...
            >
              ...
              <svg width="8" height="8" viewBox="0 0 8 8" fill="currentColor" className={`transition-transform ${langOpen ? 'rotate-180' : ''}`}>
